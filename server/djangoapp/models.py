...
class CarMake(models.Model):
    name = models.CharField(null = False, max_length = 30) # Name
    ...
    def __str__(self):
        return self.name + " from " + self.country # - method to print a car make object


# <HINT> Create a Car Model model 
class CarModel(models.Model):
    name = models.ForeignKey(CarMake, on_delete = models.CASCADE) # - Many-To-One relationship to Car Make model (One Car Make has many Car Models, using ForeignKey field)
    ...
    def __str__(self):
        return self.name + " " + self.model + ". Year: " + self.year # - __str__ method to print a car make object
